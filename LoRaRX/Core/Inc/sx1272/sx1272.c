...
static DioIrqHandler *DIO0_IrqHandler = SX1272OnDio0Irq;
static DioIrqHandler *DIO1_IrqHandler = SX1272OnDio1Irq;
static void* DIO0_Context = NULL;
static void* DIO1_Context = NULL;
/*!
 * Tx and Rx timers
 */
